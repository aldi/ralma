        ...
        <div className="container">
          <div className="columns">
            <div className="column is-10 is-offset-1">
              ...
              <div className="message is-warning mt-4">
                ...
                <div className="message-body">
                  <p>
                    ...
                    <code>componentNames</code> when you need the complete tag list, and{' '}
                    <code>hrefAwareComponentNames</code> to inspect which tags sanitize links.
                  </p>
                </div>
              </div>
              ...
              <article className="content mt-5">
                <h2 className="title is-4">hrefAwareComponentNames</h2>
                <p className="subtitle is-6">
                  Use the exported set to inspect which components sanitize their <code>href</code>{' '}
                  value before rendering a link.
                </p>
              </article>
            </div>
          </div>
